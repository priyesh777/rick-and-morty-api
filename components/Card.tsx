...
export const Card = (props: Props) => {
    ...
    return (
        <div className="max-w-sm border-2 border-rose-500 rounded-md p-1 m-5 w-[calc(33.333% - 16px)] mb-4">
            <a href="#">
                <img className="rounded w-full" src={`${data?.image}`} alt="character-image" />
            </a>
            <div className="p-5">
                <a href="#">
